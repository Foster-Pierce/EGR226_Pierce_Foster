...
void main(void)
{
    ...
    P1SEL1 &= ~BIT1; // configure P4.6 as simple I/O SWITCH
    P1SEL0 &= ~BIT1;
    P1DIR &= ~BIT1;
    P1REN |= BIT1;
    P1OUT |= BIT1;

    P2SEL1 &= ~BIT0; // configure P2.0 as simple I/O RED
    P2SEL0 &= ~BIT0;
    P2DIR |= BIT0;
    P1REN &= ~BIT0;
    P1OUT &= ~BIT0;

    P2SEL1 &= ~BIT1; // configure P2.1 as simple I/O YELLOW
    P2SEL0 &= ~BIT1;
    P2DIR |= BIT1;
    P2REN &= ~BIT1;
    P2OUT &= ~BIT1;

    P2SEL1 &= ~BIT2; // configure P2.2 as simple I/O GREEN
    P2SEL0 &= ~BIT2;
    P2DIR |= BIT2;
    P2REN &= ~BIT2;
    P2OUT &= ~BIT2;
